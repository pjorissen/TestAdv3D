...
public class ControlEnemySeek : MonoBehaviour
{
    ...
    void Update()
    {
        moveDirection = new Vector3(fleeTarget.position.x - transform.position.x, 0,  fleeTarget.position.z - transform.position.z);
